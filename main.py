...
def train(model, training_data, validation_data, optimizer, args, device):
    ...
    for epoch in range(args.Epoch):
        ...
        if best_mrr < valid_mrr:
            ...
            print("Skip this step...and the value is: ", valid_mrr)

        
        with open('OrgAT.txt', 'a') as f:
            f.write(info + ': The train process has done.' + '\n')
...
def main():
    ...
    # parser.add_argument('--dataset', type=str, default='smallData/', help='name of dataset.java, python')
    parser.add_argument('--dataset', type=str, default='bigData/', help='name of dataset.java, python')
    ...
    parser.add_argument('--Epoch', type=int, default=15, help="Training Epoch")#default是训练次数，可以改
    ...
    if args.mode == 'train':
        print('This process is for APIs and Tokens with original vector')
